...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessengerifyApi.UserAuth();
  });
  ...
  describe('UserAuth', function() {
    it('should create an instance of UserAuth', function() {
      ...
      //var instane = new MessengerifyApi.UserAuth();
      //expect(instance).to.be.a(MessengerifyApi.UserAuth);
    });

    it('should have the property login (base name: "login")', function() {
      // uncomment below and update the code to test the property login
      //var instance = new MessengerifyApi.UserAuth();
