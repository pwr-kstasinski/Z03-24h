...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessengerifyApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new MessengerifyApi.InlineObject();
      //expect(instance).to.be.a(MessengerifyApi.InlineObject);
    });

    it('should have the property content (base name: "content")', function() {
      // uncomment below and update the code to test the property content
      //var instance = new MessengerifyApi.InlineObject();
