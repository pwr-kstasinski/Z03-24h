...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessengerifyApi.UserData();
  });
  ...
  describe('UserData', function() {
    it('should create an instance of UserData', function() {
      ...
      //var instane = new MessengerifyApi.UserData();
      //expect(instance).to.be.a(MessengerifyApi.UserData);
    });

    it('should have the property login (base name: "login")', function() {
      // uncomment below and update the code to test the property login
      //var instance = new MessengerifyApi.UserData();
